  ...
  return (
    <div className="px-4 pb-24 pt-6">
      ...
      <div className="grid grid-cols-2 gap-3 mb-5">
        <SummaryCard label="This Month" value={formatINR(totalMonth)} accent />
        <SummaryCard label="This Week" value={formatINR(totalWeek)} />
      </div>
...
function SummaryCard({ label, value, accent }: { label: string; value: string; accent?: boolean }) {
  return (
    <div className={`finova-card p-4 ${accent ? "gradient-card" : ""}`}>
